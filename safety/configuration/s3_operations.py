...
from safety.constant import * 
from safety.exception import SDException as isdException
...
from safety.constant.training_pipeline import AWS_ACCESS_KEY, AWS_SECRET_KEY, AWS_REGION_NAME
...
class S3Operation:
    def __init__(self):
        ...
        if __access_key_id is None:
            raise Exception("Environment variable: ACCESS_KEY is not not set.")
