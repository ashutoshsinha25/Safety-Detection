...
from safety.entity.artifact_entity import DataIngestionArtifact
...
class DataIngestion:
    ...
    def extract_zip_file(self,zip_file_path: str)-> str:
        try:
            ...
            logging.info(f"Extracting {zip_file_path} into directory {feature_store_path}")
            with zipfile.ZipFile(zip_file_path, 'r') as zip_ref:  
                zip_ref.extractall(feature_store_path)  
            logging.info(f"Extracted {zip_file_path} into directory {feature_store_path}")
